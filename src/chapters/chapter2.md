...
Finally, we're getting to the real meaty stuff: *app.* files and *main-page.* files. When your app runs, the first piece of app code that runs is the app.js file. In a sense, you can think of the app.js file as a bootstrapper for your application. Let's open it up an see what's inside:
